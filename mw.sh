...
toilet -f standard " Mr.Tuman " -F gay
echo
echo ""
echo "\033[34;1m[^_^]\033[36;1m===============================================\033[34;1m[^_^]"
echo $green"|  [Author      ]: Mr.Tuman °      °         °     °  |"
echo $yellow"|  [Version     ]: Deface Multi Brute Webdav  °       °  |"
echo $red"|  [Team        ]: Termux Tools-ID  °      °      °    ° |"
echo $white"|  [Phone       ]: 085230354351     °       °     °   °  |"
echo $purple"|  °      °	   [Thanks To All Member]     °          |"
echo $cyan"|  °	     °   °   [IC.net] °	  	°|" 
echo $green"|°	°       °[ShaDoW BlooD InDoNeSiA]°	   °   ° |"
echo $yellow"|	     °     [BlackWare]   °    °     °   |"
echo $red"|  °	 °        °   [Jabar Cyber Army]°	    °      °    °|"
echo "\033[34;1m[^_^]\033[36;1m===============================================\033[34;1m[^_^]"
sleep 1
echo
